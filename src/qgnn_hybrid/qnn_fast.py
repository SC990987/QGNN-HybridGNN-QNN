"""
Fast PyTorch quantum circuit simulation utilities.

Original simulator implementation by Eric Reinhardt, used with permission.
Integrated into this project by Samuel Campbell for hybrid GNN-QNN experiments.
"""
